                    ...
                    <div className="row">
                        ...
                        <div className="col text-center text-lg-start">
                            ...
                            <ul className="list-inline">
                                <li className="list-inline-item my-2"><a href="mailto:s2725566932@gmail.com" className="fs-5 link-light text-decoration-none"><i
                                    className="bi bi-envelope pe-1"></i>
                                    <span className="text-center">E-mail</span></a></li>
                                <li className="list-inline-item my-2"><a href="https://www.linkedin.com/in/zhenrong-shi/" className="fs-5 link-light text-decoration-none"><i
                                    className="bi bi-linkedin pe-1"></i>
                                    LinkedIn</a></li>
                                <li className="list-inline-item my-2"><a href="https://github.com/Jonszr" className="fs-5 link-light text-decoration-none"><i
